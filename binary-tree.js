...
class BinaryTree {
  ...
  minDepth() {
    ...
    function findMinDepth(node) {
      ...
      let leftDepth = node.left ? findMinDepth(node.left) : 0;
      let rightDepth = node.right ? findMinDepth(node.right) : 0;
  ...
  maxDepth() {
    ...
    function findMaxDepth(node) {
      ...
      let leftDepth = node.left ? findMaxDepth(node.left) : 0;
      let rightDepth = node.right ? findMaxDepth(node.right) : 0;
